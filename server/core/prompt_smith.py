...
LOOKS_SYS = (
    ...
    "POSE RULE (hard): the `pose` field describes ONLY what her own body does - stance, hips, "
    "arms, hands, head, gaze, expression. She stands ALONE on an empty studio backdrop. Never "
    "put an object, prop, vehicle, furniture or machine in the pose: no leaning on a car, no "
    "reaching for a siren, no holding equipment, no examining a monitor, no sitting on anything. "
    "The only object she may hold is one named in the THEME's signature pieces. "
