"""Upload the Anime Dance Streamer AAB and stage a draft release on the
closed testing track. Testers/countries/rollout finish in the Console UI.

Run: python "C:/Projects/Auto Game Builder/tools/playstore/animestreamer_upload.py"
"""
...
AAB = r"C:\Projects\Anime Dance Streamer Clicker\build\app\outputs\bundle\release\app-release.aab"
